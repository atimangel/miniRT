...
/*   Updated: 2022/02/19 11:12:32 by snpark           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parse_plane(const char *line, t_rt *img_format, t_bool *flag)
{
	...
	*flag = TRUE;
	...
	img_format->plane->normalized_orientation_vector = parse_normal_vector(&line);
...
void	parse_cylinder(const char *line, t_rt *img_format, t_bool *flag)
{
	...
	*flag = TRUE;
	...
	img_format->cylinder->normalized_orientation_vector = parse_normal_vector(&line);
